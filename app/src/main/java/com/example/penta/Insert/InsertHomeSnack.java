...
public class InsertHomeSnack extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.home_insert_snack);
        ...
        insert.setOnClickListener(view -> {
            ...
            Boolean insertFood = DB.insertData("snack",koreanText, gramsText, caloriesText, carbsText, proteinsText, fatsText, Home.Time());
            if(insertFood == true){
                Toast.makeText(InsertHomeSnack.this, "새로운 식단 정보가 입력되었습니다", Toast.LENGTH_SHORT).show();
                Log.d("dbInsert","식단 정보가 입력되었습니다.");
            }
            else{
                Toast.makeText(InsertHomeSnack.this, "식단 정보 입력에 실패하였습니다", Toast.LENGTH_SHORT).show();
                Log.d("dbInsert","입력을 실패했습니다.");
            }
            Intent i = new Intent(InsertHomeSnack.this, Main.class);
            startActivity(i);
        });
    }
}
